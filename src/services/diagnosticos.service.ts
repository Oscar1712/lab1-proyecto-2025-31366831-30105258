...
class DiagnosticosService {
    // Crear un nuevo diagnóstico asociado a un episodio
    ...
    // Obtener todos los diagnósticos de un episodio
    ...
    // Marcar un diagnóstico como inactivo (no se borra por trazabilidad legal)
