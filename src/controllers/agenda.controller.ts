...
// Importamos los tipos inferidos directamente desde el esquema
import { 
    BloqueAgendaInput, 
    BloqueAgendaInput as BloqueAgendaUpdateInput, // Reutilizamos el tipo base para el update (aunque Partial)
    SearchBloquesQuery 
} from '../schemas/bloqueAgenda.schema.js';
 ...
 */
export async function getAllBloques(req: Request, res: Response, next: NextFunction) {
    try {
        ...
        const filters = req.query as unknown as SearchBloquesQuery;
 ...
 */
export async function getBloqueById(req: Request, res: Response, next: NextFunction) {
    try {
...
export async function createBloque(req: Request, res: Response, next: NextFunction) {
    try {
        ...
        const data: BloqueAgendaInput = req.body;
...
export async function updateBloque(req: Request, res: Response, next: NextFunction) {
    try {
        ...
        const data: Partial<BloqueAgendaUpdateInput> = req.body;
