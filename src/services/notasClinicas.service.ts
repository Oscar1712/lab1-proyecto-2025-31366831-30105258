...
import type { Prisma, NotaClinica as PrismaNotaClinica } from '../generated/prisma/client.js'; 
    ...
    async update(id: number, data: Partial<NotaClinicaInput>) {
        ...
        if (data.episodioId || data.profesionalId) {
             await this.validateDependencies(
                data.episodioId || (await this.getById(id)).episodioId,
                data.profesionalId || (await this.getById(id)).profesionalId,
            );
        }
