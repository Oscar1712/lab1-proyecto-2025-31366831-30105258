 ...
 */
export async function getAllDiagnosticosByEpisodio(req, res) {
    try {
 ...
 */
export async function getDiagnosticoById(req, res) {
    try {
 ...
 */
export async function createDiagnostico(req, res) {
    try {
 ...
 */
export async function updateDiagnostico(req, res) {
    try {
 ...
 */
export async function deleteDiagnostico(req, res) {
    try {
        // Validación del ID del diagnóstico
        const id = idParamSchema.parse(req.params.id);
