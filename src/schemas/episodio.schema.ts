...
/**
 * Tipo para los Query Parameters de búsqueda (para uso en episodio.service.ts).
 */
export type SearchEpisodiosQuery = z.infer<typeof searchEpisodiosSchema>['query'];