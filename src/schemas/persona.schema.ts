...
export const personaAtendidaSchema = z.object({
  ...
  fechaNacimiento: dateSchema.refine(
    date => {
...
export const updatePersonaSchema = z.object({
  ...
  body: personaAtendidaSchema.partial().refine(
...
export type PersonaAtendidaInput = z.infer<typeof personaAtendidaSchema>;
export type CreatePersonaInput = z.infer<typeof createPersonaSchema>['body'];
export type UpdatePersonaInput = z.infer<typeof updatePersonaSchema>['body'];