 ...
 */
export async function getAllNotasClinicas(req, res) {
    try {
 ...
 */
export async function getNotaClinicaById(req, res) {
    try {
 ...
 */
export async function createNotaClinica(req, res) {
    try {
 ...
 */
export async function updateNotaClinica(req, res) {
    try {
 ...
 */
export async function deleteNotaClinica(req, res) {
    try {
        // Validación del parámetro ID (params)
        const id = idParamSchema.parse(req.params.id);
...
//# sourceMappingURL=notasClinicas.controller.js.map