...
export const bloqueAgendaSchema = z.object({
    ...
    inicio: dateSchema.refine(date => date.getTime() >= Date.now() - 1000, { message: 'La fecha de inicio debe ser futura' }),
    fin: dateSchema,
    capacidad: z.number()
        .int()
...
export const updateBloqueAgendaSchema = z.object({
    ...
    body: bloqueAgendaSchema.partial().refine(data => {
...
//# sourceMappingURL=bloqueAgenda.schema.js.map